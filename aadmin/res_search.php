...
// Adding the condition to exclude account_type = 1
$query = "SELECT * FROM users WHERE CONCAT_WS(' ', firstname, middlename, lastname) LIKE ? AND account_type != 1 ORDER BY lastname, firstname";
...
<div class="centered-form-wrapper">
    <form action="manage_residents.php" method="get" class="centered-form">
